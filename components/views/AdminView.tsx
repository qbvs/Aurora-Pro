...
// We import the ReturnType of the hook to strictly type the props if needed,
// but for cleaner code here we can trust the controller object spread.
// For strict TS, we'd define interface AdminViewProps extends ReturnType<typeof useAppController> {}
